...
| 3 | ~~站内邮箱~~ **已完成** | ✅ 已开通阿里云企业邮箱免费版（¥0，51 账号，到期 2027-09-21），站点邮箱已设为 **`yale@tpematsfactory.com`**。发布前已验证：账号存在且状态「正常」、MX/SPF 公网解析正确、收信链路有真实到信。**建议补 DKIM**（控制台显示 `default._domainkey` 未通过，只影响外发被判垃圾邮件的概率，不影响收信） |
